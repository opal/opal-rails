...
describe 'In-browser specs runner' do
  it 'runs all specs', :js do
    visit '/opal_spec'
    page.should have_content('Running: subdirectory/example_spec.js example_spec')
    page.should have_content('2 examples, 0 failures')
  end

  it "runs single spec file", :js do
    visit '/opal_spec'
    click_link 'subdirectory/example_spec.js'
    page.should have_content('Running: subdirectory/example_spec.js')
